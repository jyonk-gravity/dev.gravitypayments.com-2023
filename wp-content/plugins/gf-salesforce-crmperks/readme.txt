...
<p>Following features are available only in premium version. <a href="https://www.crmperks.com/plugins/gravity-forms-plugins/gravity-forms-salesforce-plugin/?utm_source=wordpress&utm_medium=directory&utm_campaign=salesforce_readme">Gravity Forms Salesforce Add-on Pro</a>.</p>
<ul>
...
We have Premium Extensions for 20+ CRMs.[View All CRM Extensions](https://www.crmperks.com/plugin-category/gravity-forms-plugins/?utm_source=wordpress&utm_medium=directory&utm_campaign=salesforce_readme)
...
1. Connecting Salesforce Account to Gravity Forms.
2. Mapping Salesforce fields.
3. Gravity Forms Salesforce crm logs.
4. Manually Send Gravity Forms entry to Salesforce crm.
...
= 1.3.8 =
* fixed "empty checkbox with payment trigger" issue.
* fixed "salesforce date field timezone" issue.

= 1.3.7 =
* fixed "send to salesforce" checkbox issue in gravity entry.

= 1.3.6 =
* added filter for adding primary key fields.

= 1.3.5 =
* fixed "Trying to get property 'type' of non-object" issue.

= 1.3.4 =
* fixed "entry does not exist" issue.
* fixed "live options mapping" issue.

= 1.3.3 =
* fixed "failed logs search" issue.

= 1.3.2 =
* added "after form submission" event.

= 1.3.1 =
* fixed "salesforce ID in merge tags" issue.

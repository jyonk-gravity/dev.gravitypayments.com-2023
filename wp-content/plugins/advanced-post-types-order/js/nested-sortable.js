...
(function( factory ) {
    ...
    $.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
        ...
        _mouseDrag: function(event) {
            ...
            if (parentItem != null &&
                nextItem == null &&
                this.options.keepInSameLevel !=  true   &&
                ...
                if(this.options.disableNesting != true  &&  this.options.keepInSameLevel !=  true)
                    {
            ...
            $(items).each(function() {
                var res = ($(o.item || this).attr(o.attribute || "id") || "")
                    ...
                    pid = ($(o.item || this).parent(o.listType)
                        ...
                        .attr(o.attribute || "id") || "")
                        .match(o.expression || (/(.+)[-=_](.+)/)),
                    sticky = jQuery(this).find('.a_sticky').length > 0 ?  jQuery(this).find('.a_sticky .sticky-input').val()  :   '';
                ...
                if (res) {
                    ...
                    if(sticky != '')
                        sticky_list.push('sticky_item[' + (o.key && o.expression ? res[1] : res[2]) +  ']=' + sticky);
                }
            });

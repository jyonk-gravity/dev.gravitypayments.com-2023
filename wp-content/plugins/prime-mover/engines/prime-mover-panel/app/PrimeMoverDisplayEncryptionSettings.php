...
class PrimeMoverDisplayEncryptionSettings
{
    ...
    private function outputMarkup()
    {
        ...
        if (false === apply_filters('prime_mover_is_config_usable', false)) {
            $readonly = 'readonly';
            $disabled = 'disabled';
                ...
                <div class="prime-mover-setting-description">
                   <p class="description">
                    <label for="js-prime_mover_encryption_key_panel_checkbox">
                        ...
                        <span id="js-show-hide-encryption-key"><?php esc_html_e('Show encryption key saved in wp-config.php', 'prime-mover');?></span>
                    </label>
                    </p>               

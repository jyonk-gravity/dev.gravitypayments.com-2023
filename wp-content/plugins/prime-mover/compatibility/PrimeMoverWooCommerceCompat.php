...
{     
    ...
    public function __construct(PrimeMover $prime_mover, $utilities = [])
    {
        ...
        $this->callbacks = [
            ...
            'maybeAdjustUserIdsApiKeys' => 13,
            'maybeAdjustUserIdsWebHooks' => 14,
            'maybeAdjustUserIdsPaymentTokens' => 15
        ];
    }
    ...
    public function forceRedirectToPermalinkPage($location = '')
    {
        ...
        $args = [
            'prime_mover_force_redirect_to_permalinks' => FILTER_SANITIZE_STRING, 
            'prime_mover_force_redirect_nonce' => FILTER_SANITIZE_STRING, 

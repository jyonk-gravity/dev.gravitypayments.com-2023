...
class PrimeMoverDownloadUtilities
{
    ...
    {
        $filters = [
            'HTTP_X_PRIME_MOVER_AUTHORIZATION' => FILTER_SANITIZE_STRING,
    ...
    {
        $args = [
            'prime_mover_download_nonce' => FILTER_SANITIZE_STRING,
            'prime_mover_export_hash' => FILTER_SANITIZE_STRING,
    ...
    {
        return $this->getSystemFunctions()->createFriendlyName($blogid_to_export, $download_path, $is_wprime);
    }
}
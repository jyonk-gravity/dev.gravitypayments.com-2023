...
class PrimeMoverImportUtilities
{
    ...
    public function verifyPluginsThemesIncluded(array $import_data)
    {
        ...
        if ($include_themes && $include_plugins && isset($import_data['diff'])) {
            //Importing plugins/themesRemove diff
     ...
     * 
     * @param array $import_data
     * @param $copy_directory_result
     * @param array $plugins
     * @param string $plugins_imported_package_path
     * @param number $blog_id
     * @return []
     */
    protected function returnRetryCopyDirectoryResult($import_data = [], $copy_directory_result = [], $plugins = [], $plugins_imported_package_path = '', $blog_id = 0)
    {

...
define('PRIME_MOVER_VERSION', '1.6.6');
...
if (!defined('CODEXONICS_PACKAGE_MANAGER_RESTORE_GUIDE')) {
    define('CODEXONICS_PACKAGE_MANAGER_RESTORE_GUIDE', 'https://codexonics.com/prime_mover/prime-mover/how-to-restore-large-packages-with-prime-mover-free-version/');
}

        ...
        public function plugin_row_meta( $plugin_meta, $plugin_file ) {
            if ( ASP_PLUGIN_BASE === $plugin_file ) {
                ...
                $row_meta = [
                    ...
                    'changelog' => '<a href="https://knowledgebase.ajaxsearchpro.com/other/changelog" title="' . esc_attr( __( 'View Ajax Search Pro Pro Changelog', 'ajax-search-pro' ) ) . '" target="_blank">' . __( 'Changelog', 'ajax-search-pro' ) . '</a>',
                ];

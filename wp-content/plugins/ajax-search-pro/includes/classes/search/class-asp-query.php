    ...
    class ASP_Query {
        ...
        public function get_posts() {
            ...
            foreach ($this->finalPhrases as $s) {
                ...
                if ( in_array('peepso_groups', $args['search_type']) ) {
                    foreach ( $logics as $lk => $logic ) {
                        if ( $lk == 0 && $args['_exact_matches'] == 1 ) {
                            // If exact matches is on, disregard the firs logic
                            $args['keyword_logic'] = 'or';
                        ...
                        $_peepg = new ASP_Search_PeepsoGroups($args);
                ...
                if ( in_array('peepso_activities', $args['search_type']) ) {
                    foreach ( $logics as $lk => $logic ) {
                        if ( $lk == 0 && $args['_exact_matches'] == 1 ) {
                            // If exact matches is on, disregard the firs logic
                            $args['keyword_logic'] = 'or';
                        ...
                        $_peepg = new ASP_Search_PeepsoActivites($args);
                        $_peepg_res = $_peepg->search($s);

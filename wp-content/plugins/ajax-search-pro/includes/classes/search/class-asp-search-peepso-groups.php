...
if (!class_exists('ASP_Search_PeepsoGroups')) {
    /**
     * Comment search class
     *
     * @class       ASP_Search_PeepsoGroups
     * @version     1.0
     * @package     AjaxSearchPro/Abstracts
     * @category    Class
     * @author      Ernest Marcinko
     */
    class ASP_Search_PeepsoGroups extends ASP_Search_CPT {
        /**
                        ...
                        if ($image_settings['show_images'] != 0 &&
                            ...
                            if ($image_settings['image_cropping'] == 0) {
                                ...
                                if (strpos($im, "mshots/v1") === false) {
                                    ...
                                    $r[$k]->image = bfi_thumb($im, $bfi_params);
                                } else {
                                    $r[$k]->image = $im;
                                }
                            }

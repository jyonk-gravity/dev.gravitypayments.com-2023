                    ...
                    if (isset($sd['image_options'])) {
                        foreach ($groupresults as $k => $v) {
                            ...
                            if ($sd['image_options']['show_images'] == 1) {
                                ...
                                if ($im != '') {
                                    $groupresults[$k]->image = ASP_Helpers::fixSSLURLs($im);
                                }
                            }
                 ...
                 WHERE
                   ...
                   LIMIT " . $limit;
                    ...
                    foreach ($activityresults as $k => $v) {
                        ...
                        $activityresults[$k]->image = ASP_Helpers::fixSSLURLs( bp_core_fetch_avatar(array('item_id' => $v->author_id, 'html' => false)) );

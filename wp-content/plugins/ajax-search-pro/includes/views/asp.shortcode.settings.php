...
<form name='options' class="asp-fss-<?php echo $style['fss_column_layout']; ?>" autocomplete = 'off'>
    ...
    <?php if ( class_exists('PeepSo') ): ?>
        <input type="hidden" style="display:none;" name="peepso_object_type" value="<?php echo apply_filters('peepso_object_type', 0); ?>">
        <input type="hidden" style="display:none;" name="peepso_object_id" value="<?php echo apply_filters('peepso_object_id', 0); ?>">
    <?php endif; ?>

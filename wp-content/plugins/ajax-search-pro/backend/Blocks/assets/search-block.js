...
(function () {
    ...
    registerBlockType('ajax-search-pro/block-asp-main', {
        ...
        edit: function (props) {
            ...
            }, /*#__PURE__*/React.createElement("label", null, __('Ajax Search Pro:', domain), /*#__PURE__*/React.createElement("select", {
                value: scType,
                onChange: setscType
            }, /*#__PURE__*/React.createElement("option", {
                value: "1"
            }, __('Search bar', domain)), /*#__PURE__*/React.createElement("option", {
                value: "2"
            }, __('Search settings', domain)), /*#__PURE__*/React.createElement("option", {
                value: "3"
            }, __('Search results', domain)))), /*#__PURE__*/React.createElement("label", null, __('Search ID:', domain), /*#__PURE__*/React.createElement("select", {
                value: instance,
        ...
        save: function (props) {
            ...
            return /*#__PURE__*/React.createElement(AspShortcode, {
                instance: instance,
                scType: scType
            });
        }

...
jQuery(function($){
    ...
    $('.wpdreamsUpload .wdUploadButton').on('click', function(e){
        ...
        custom_uploader.on('select', function () {
            ...
            $cup_text.val(attachment.url).change();
        });
    ...
    */
    ...
    $('div.wd_cpt_search').each(function() {
        ...
        $("input.wd_cpt_search", parent).keyup(function () {
            var $this = $(this);
            clearTimeout(timeout);
            if ( $this.val() == '' ) {
                $('.wd_ts_close', parent).addClass("hiddend");
        ...
        $("input.wd_cpt_search", parent).click(function () {
            $res.css({
                display: 'block'
            });
        });
                    ...
                    $.each($nodes, function (key, node) {
                        ...
                        setTimeout(function (tc, xnode) {
                            ...
                            t = setTimeout(function () {
                                ...
                                $("#asp_preview_window .refresh").click();
    ...
    $('.wpdreamsBoxShadow input[type=text], .wpdreamsBoxShadow select').on('change', function () {
        ...
        $('input[type=hidden]', parent).val(boxshadow).change();
    });

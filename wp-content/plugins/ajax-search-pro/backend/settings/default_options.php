...
function asp_do_init_options() {
	...
	$options['asp_compatibility_def'] = array(
		...
		'js_source_def'                  => array(
			array(
				'option' => 'Non minified',
				'value'  => 'jqueryless-nomin',
			),
			array(
				'option' => 'Minified (default)',
	...
	$options['asp_defaults'] = array(
		...
		'post_type_order'                         => get_post_types(
			array(
				'public'   => true,
				'_builtin' => false,
			),
		...
		'user_search_advanced_title_field'        => "{result_field field_name='title' hash='x'}",
		'user_search_advanced_description_field'  => "{result_field field_name='content' hash='y'}",
	...
	// suggestions
		...
		'frontend_search_settings_position'       => 'block', // hover, block
		...
		'frontend_terms_unselect_parent'          => 0,
		...
		'advtitlefield'                           => "{result_field field_name='title' hash='x'}",
		'advdescriptionfield'                     => "{result_field field_name='content' hash='y'}",
		...
		'lightbox_navigation'                     => 1,
		'lightbox_disable_right_click'            => 1,
		'lightbox_close_icon'                     => 1,
		'lightbox_animation_speed'                => 250,
		'lightbox_doc_close'                      => 1,
		'lightbox_disable_scroll'                 => 1,
		'lightbox_enable_keyboard'                => 1,
		...
		'box_margin_top'                          => 0,
		'box_margin_bottom'                       => 0,
		'boxbackground'                           => '0-60-rgb(225, 65, 153)-rgb(225, 65, 153)',
		'boxborder'                               => 'border:0px none rgb(0, 0, 0);border-radius:30px 30px 30px 30px;',
		...
		'settingsbackground'                      => '1-185-rgba(255, 255, 255, 0)-rgba(255, 255, 255, 0)',
		...
		'settingsdropbackground'                  => '1-185-rgb(225, 65, 153)-rgb(225, 65, 153)',
		...
		'resultsborder'                           => 'border:2px solid rgb(225, 65, 153);border-radius:3px 3px 3px 3px;',
		'resultshadow'                            => 'box-shadow:0px 4px 28px -13px rgb(0, 0, 0) ;',
		'resultsbackground'                       => 'rgb(255, 255, 255)',
		...
		'spacercolor'                             => 'rgba(255, 255, 255, 0.55)',
		...
		'h_item_width'                            => '200px',
		'h_item_width_tablet'                     => '200px',
		'h_item_width_phone'                      => '200px',

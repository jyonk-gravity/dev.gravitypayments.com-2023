...
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ asp_addons_simplelightbox; }
});
...
class SimpleLightBoxAddon {
  ...
  init() {
    Hooks.addFilter("asp/search/end", this.addSimpleBox.bind(this), 10, this);
  }
  addSimpleBox($this) {
    ...
    const args = Hooks.applyFilters("asp/addons/simplelightbox/args", {
      // @ts-ignore
      ...$this.o.lightbox,
    ...
    external_DoMini_default()(`.asp_r_${$this.o.rid} .item`).forEach((el) => {
      const image = external_DoMini_default()(el).find("a.asp_res_url");
      if (image.length > 0 && isImageUrl(image.attr("href"))) {
        const node = external_DoMini_default()(el);
        node.off("click");
...
external_AjaxSearchPro_default().addons.add(new SimpleLightBoxAddon());
...
/* harmony default export */ var asp_addons_simplelightbox = (external_AjaxSearchPro_namespaceObject);
